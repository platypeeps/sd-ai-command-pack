...
- `all` — review the entire checked-out repository instead of the current
  ...
  flag, `bash sd-ai-command-pack-review-local.sh --full-codebase`,
...
```bash
bash sd-ai-command-pack-review-local.sh
```
...
```bash
bash sd-ai-command-pack-review-local.sh --list-tools
bash sd-ai-command-pack-review-local.sh prism
bash sd-ai-command-pack-review-local.sh gito
bash sd-ai-command-pack-review-local.sh prism gito
SD_AI_COMMAND_PACK_REVIEW_LOCAL_TOOLS="prism gito" bash sd-ai-command-pack-review-local.sh
```
...
If `sd-ai-command-pack-review-local.sh` is missing, stop and report
