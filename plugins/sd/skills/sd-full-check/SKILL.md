...
bash sd-ai-command-pack-full-check.sh
```
...
through `bash sd-ai-command-pack-toolchain.sh run-python
...
5. Structural post-install audit through
   `sd-ai-command-pack-install-audit.py`, verifying that copied pack
