...
- `all` — review the entire checked-out repository instead of the current
  ...
  flag, `bash ~/.agents/bin/sd-ai-command-pack-review-local.sh --full-codebase`,
...
```bash
bash ~/.agents/bin/sd-ai-command-pack-review-local.sh --list-tools
bash ~/.agents/bin/sd-ai-command-pack-review-local.sh prism
bash ~/.agents/bin/sd-ai-command-pack-review-local.sh gito
bash ~/.agents/bin/sd-ai-command-pack-review-local.sh prism gito
SD_AI_COMMAND_PACK_REVIEW_LOCAL_TOOLS="prism gito" bash ~/.agents/bin/sd-ai-command-pack-review-local.sh
```
...
`~/.agents/bin/sd-ai-command-pack-review-local.sh`.
...
If `~/.agents/bin/sd-ai-command-pack-review-local.sh` is missing, stop and report
