---
description: Take the current branch from committed work to a merged pull request by sequencing the standard SD create-pr, routed review, lifecycle, watch-pr, and housekeeping stages.
---
