...
is missing while not gitignored, or when a vouched path is a symlink or
other non-regular node, making the "reviewed upstream" exemption for
vendored pack files a checkable claim.
