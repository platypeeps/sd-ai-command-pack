...
|---|------|-------|---------|--------|
| 458 | 2026-08-29 | Review coordinator correctness: disposition reasons, outdated threads, remote attempt sequencing | `a3da4ea1`, `c837881b`, `00e28d78`, `e83874a7`, `1ac9f293` | `task/08-29-review-coordinator-correctness` |
...
| 360 | 2026-08-11 | Rescope the candidate validator loop to the thin shape | `686d077e`, `da292873`, `0e86e0a8`, `3f45751f`, `e7c90d23`, `c71ac33b` | `feat/thin-candidate-loop-shape` |
| 359 | 2026-08-11 | Bind the candidate validator's own sources into the candidate ledger | `ff82e490`, `9e8fead2`, `36e1958b`, `adcbe2ad` | `feat/candidate-validator-digest` |
...
| 291 | 2026-08-04 | Register fleet-refresh.operator-policy structured decision (0.64.9) | `f2a77537` | `feat/register-fleet-operator-policy` |
...
| 281 | 2026-08-03 | Ship sd skills to Claude Code .claude/skills/sd-* (fanout parity) | `ac1243b9` | `main` |
| 280 | 2026-08-02 | Abandon review_preflight in-proc install conversion (hypothesis falsified) | - | `main` |
...
| 244 | 2026-07-27 | Add canonical release preparation | `da7c4cc` | `codex/add-release-prep-command` |
...
| 233 | 2026-07-26 | Recover PR 255 and harden post-archive finalization | `d6d7a12`, `dd4debe`, `ab82fde`, `1603947`, `49aabeb`, `aafcd5d` | `codex/support-post-archive-review-finalization` |
...
| 223 | 2026-07-24 | Feed review learnings into review planning | `8884408` | `codex/feed-review-learnings-into-planning` |
| 222 | 2026-07-24 | Deliver deterministic read-only sd-check | `a39cd90`, `93fc291` | `codex/read-only-sd-check` |
...
| 170 | 2026-07-21 | Self-heal stale Obsidian KB during full-check | `bdaec76` | `codex/self-heal-stale-obsidian-kb` |
...
| 92 | 2026-07-14 | Script hardening (optimization Batch B) | `1860270` | `perf/script-hardening` |
| 91 | 2026-07-14 | Installer simplifications (optimization Batch A) | `ace99b5`, `1866db6` | `perf/installer-simplifications` |
| 90 | 2026-07-14 | Parallelize the test suite by module | `16b57f8`, `a3405e4` | `perf/test-parallelization` |
| 89 | 2026-07-14 | Complete remaining P2 task closeout | `7bda94c` | `codex/address-remaining-p3-tasks` |
| 88 | 2026-07-11 | Plan tool-use hardening | `e5722e1`, `80ac9c2` | `codex/plan-tool-use-hardening` |
| 87 | 2026-07-10 | Harden local review tooling | `788f321`, `d7e91de` | `codex/harden-local-review-tooling` |
...
| 1 | 2026-06-26 | Bootstrap Trellis specs | `2ca8cbb` | `codex/bootstrap-trellis-specs` |
<!-- @@@/auto:session-history -->
