...
| Hash | Message |
|------|---------|
| `fef874c7` | feat(scripts): own-location sibling resolution for pack scripts |
| `a93b3123` | feat(plugin): Claude Code plugin generator, marketplace catalog, generated tree |
| `4b7350f4` | feat(plugin): wire generator into make generate, lint lanes; add test suite |
| `13edb633` | feat(release): plugin generation in release chain, payload gates, CI validate, docs |
| `48fd7dc3` | docs(spec): capture script sibling-resolution contract |
| `bc2b991f` | fix(review): apply local-disposition reruns and gate on outstanding findings |
...
- [OK] sd-review PR 400 converged ready at head bc2b991f via same-attempt rebuttals
