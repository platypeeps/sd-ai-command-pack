...
Scope/trigger: any change to how `scripts/sd-ai-command-pack-fleet-publish.py`
...
`.trellis/spec/tooling/fleet-publish-generated-content.md` pins the completion
