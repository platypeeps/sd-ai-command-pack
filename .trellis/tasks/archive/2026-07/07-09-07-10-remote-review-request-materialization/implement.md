...
- [x] Focused fixtures fail before and pass after the skill change.
- [x] Template source and root mirror are byte-identical.
- [x] README/docs contain only documented Copilot identifiers.
- [x] Existing custom-provider behavior remains covered.
- [x] Version, changelog, manifest, and provenance are synchronized.
- [x] KB freshness, install audit, and deterministic full-check pass.
