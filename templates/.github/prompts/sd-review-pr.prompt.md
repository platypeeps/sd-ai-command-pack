...
3. Use the skill as the primary instructions. It defines the local full-check, optional local review providers, configured remote reviewer behavior and round limits, CI handling, the feedback loop, and documentation or pre-commit recommendations.
