...
Run the Trellis update-spec skill as-is, then refresh the repo's architectural
overview when one exists and the work warrants it.
...
3. After the update-spec pass, check whether the repo already has an
...
4. If an overview exists and the completed work changes high-level architecture
