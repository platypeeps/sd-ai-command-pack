...
lint:
	"$(VENV_PYTHON)" -m ruff check install.py installer bin/migrate-trellis bin/sd_route.py bin/sd-docs-lint bin/sd_lib.py bin/sd-check templates/scripts tests .github/scripts/check-command-surface-drift.py .github/scripts/check-helper-resolution.py .github/scripts/check-shipped-script-modes.py .github/scripts/summarize_shell_coverage.py
	"$(VENV_PYTHON)" -m mypy installer install.py bin/sd_route.py bin/sd-docs-lint bin/sd_lib.py bin/sd-check templates/scripts .github/scripts/check-command-surface-drift.py .github/scripts/check-helper-resolution.py .github/scripts/check-shipped-script-modes.py .github/scripts/summarize_shell_coverage.py
