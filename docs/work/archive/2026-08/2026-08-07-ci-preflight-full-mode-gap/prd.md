---
title: "CI never fully validates a pull request's Trellis content: full mode skips the preflight, bookkeeping mode runs it against the previous head"
status: done
created: 2026-08-07
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-07-ci-preflight-full-mode-gap`:

- research/ac-map.md
- research/diff-scope-enumeration.md
- research/evidence-demos.md
- research/evidence-fix-pr.md
- research/local-replays.md
