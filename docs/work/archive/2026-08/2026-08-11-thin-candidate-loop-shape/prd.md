---
title: Rescope the candidate validator loop to the thin shape
status: done
created: 2026-08-11
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-11-thin-candidate-loop-shape`:
