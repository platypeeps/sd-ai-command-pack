---
title: Evaluate sd-github-review repository consolidation
status: done
created: 2026-07-22
---
...
## Direction note (2026-08-08, recorded at archive)

The keep-separate decision this task produced stands and is the completed
work this archive records. Its remaining open router-contract acceptance
items are superseded by the 2026-08-08 owner-approved direction: thin working
v1 core in sd-github-review, v2 governance parked/dropped in that repo's own
consolidation, minimal durable lane shipped to the fleet (descriptor install,
durable sd-review.yml workflow, fresh pins, v0.3.0 release with enforced pin
freshness). Pack-side contract items (accept supportedContractMajors, emit
riskClass + changed-path count) are folded into
07-22-integrate-routed-review-backends. This archive is honest about what
completed versus what was overtaken.
