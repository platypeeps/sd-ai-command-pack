---
title: Normalize bot login when matching review threads
status: done
created: 2026-08-27
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-27-graphql-bot-login-thread-matching`:
