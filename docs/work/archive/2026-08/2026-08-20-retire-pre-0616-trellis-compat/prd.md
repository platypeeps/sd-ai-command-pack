---
title: Retire the pre-0.6.16 vendored Trellis compatibility layer
status: done
created: 2026-08-20
branch: task/08-20-retire-pre-0616-trellis-compat
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-20-retire-pre-0616-trellis-compat`:

- research/planning-adversarial-review.md
