---
title: "Harden task.py create: base-branch seed and description requirement"
status: done
created: 2026-08-06
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-06-task-create-base-branch-seed`:
