---
title: Remove the retired sd-full-check and sd-review-local surfaces
status: done
created: 2026-07-24
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/07-24-remove-retired-review-surfaces`:

- research/candidate-anomaly-metric-creator.log
- research/candidate-loadsmith.log
- research/candidate-rwbp-coordinator.log
- research/candidate-rwbp-website.log
- research/removal-mechanism-precedent.md
- research/retired-surface-inventory.md
