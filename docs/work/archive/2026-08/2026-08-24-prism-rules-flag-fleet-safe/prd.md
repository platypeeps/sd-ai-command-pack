---
title: Pack-driven prism reviews ignore .prism/rules.json, and turning them on would break severity in ten repos
status: done
created: 2026-08-24
...
provider — a chunked-review script under that repository's own scripts
directory, not a path in this one — declared in its own `review.json`.
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-24-prism-rules-flag-fleet-safe`:
