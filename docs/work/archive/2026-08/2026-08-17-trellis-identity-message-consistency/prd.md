---
title: "Trellis identity reporting: one diagnosis across every site"
status: done
created: 2026-08-17
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-17-trellis-identity-message-consistency`:

- design.superseded-revision.md
- implement.superseded-revision.md
