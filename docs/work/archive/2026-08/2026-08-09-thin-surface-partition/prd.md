---
title: "Surface partition: manifest + platform-registry classifier with exhaustiveness gate"
status: done
created: 2026-08-09
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-09-thin-surface-partition`:

- research/partition-counts.md
