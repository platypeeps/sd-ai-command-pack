---
title: Bare-filename documentation references are silently unchecked
status: done
created: 2026-08-19
branch: feat/preflight-bare-filename-references
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-19-preflight-bare-filename-references`:

- research/measure-baseline.mjs
- research/measure-proposed.mjs
