---
title: Shell coverage kcov lane flakes on test_completion_successor_finds_recent_anchor_in_long_history
status: done
created: 2026-08-08
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-08-shell-coverage-kcov-flake`:

- research/characterization.md
