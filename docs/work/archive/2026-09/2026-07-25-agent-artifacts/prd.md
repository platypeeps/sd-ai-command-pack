---
title: "PARKED: Ship SD commands as cross-platform sub-agents"
status: planning
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/07-25-agent-artifacts`:
