---
title: Add Codex adversarial planning review
status: done
created: 2026-07-23
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-23-add-codex-adversarial-planning-review`:

- research/claude-project-rule-integration.md
