---
title: Analyze recurring Trellis workflow instability
status: done
created: 2026-07-28
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-28-analyze-recurring-trellis-workflow-instability`:

- handoff.md
- research/recent-trellis-workflow-instability.md
