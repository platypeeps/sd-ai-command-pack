---
title: Add concurrent-installer-run test coverage
status: done
created: 2026-07-09
---
...
- [x] A concurrency test exists and passes deterministically (no flakiness on
      the CI matrix); it fails if made to write a torn receipt.
- [x] The concurrency contract is documented.
- [x] 100% line+branch installer coverage maintained; suite runtime not
