---
title: Add a fleet-controller recovery transition for retry-exhausted lanes
status: done
created: 2026-07-29
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-29-recover-retry-exhausted-fleet-lanes`:
