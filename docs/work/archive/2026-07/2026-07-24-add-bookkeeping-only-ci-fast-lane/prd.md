---
title: Add a bookkeeping-only CI fast lane
status: done
created: 2026-07-24
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-24-add-bookkeeping-only-ci-fast-lane`:

- research/current-ci-lifecycle.md
