---
title: Add server-side backstop for direct main pushes
status: done
created: 2026-07-09
---
...
- [x] A push to main touching a non-chore path fails a CI check (verified via
      a scratch branch/commit or a dry-run of the check logic).
- [x] Rename-into-chore is caught (mirror the hook test).
- [x] Policy + backstop documented; interaction with the local hook explained
