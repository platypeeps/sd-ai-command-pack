---
title: Document installer rollback and evaluate two-phase apply
status: done
created: 2026-07-09
---
...
- [x] Installed guide documents the rollback procedure; docs twins
      byte-identical; review-preflight doc-path checker passes.
- [x] Two-phase-apply decision recorded. If adopted: a test asserts a run with
