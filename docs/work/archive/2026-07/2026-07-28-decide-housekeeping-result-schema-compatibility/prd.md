---
title: Decide housekeeping result schema compatibility
status: done
created: 2026-07-28
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-28-decide-housekeeping-result-schema-compatibility`:
