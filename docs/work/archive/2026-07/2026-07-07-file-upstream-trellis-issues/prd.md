---
title: File upstream Trellis issues from deep-review findings
status: done
created: 2026-07-07
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-07-file-upstream-trellis-issues`:

- upstream-issue-1-add-session-structured-content.md
- upstream-issue-2-machine-readable-output.md
- upstream-issue-3-platform-state-contract.md
- upstream-issue-4-task-cli-hygiene.md
- upstream-issue-5-journal-duplicate-session.md
