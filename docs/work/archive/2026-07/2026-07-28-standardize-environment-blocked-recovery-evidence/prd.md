---
title: Standardize environment-blocked recovery evidence
status: done
created: 2026-07-28
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-28-standardize-environment-blocked-recovery-evidence`:

- research/workflow-program-handoff.md
