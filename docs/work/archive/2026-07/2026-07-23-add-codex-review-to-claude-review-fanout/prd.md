---
title: Add Codex review to Claude Code local review fan-out
status: done
created: 2026-07-23
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-23-add-codex-review-to-claude-review-fanout`:

- research/codex-claude-review-integration.md
