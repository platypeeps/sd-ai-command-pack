---
title: Correct fleet merge finalization head epochs
status: done
created: 2026-07-27
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-27-correct-fleet-merge-finalization-head-epoch`:

- research/corrective-findings.md
