---
title: Upstream handoff register
status: planning
created: 2026-08-08
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/08-08-upstream-handoff-register`:

- research/07-09-upstream-issue-closure-cleanup.md
- research/07-09-upstream-platform-state.md
- research/07-09-upstream-trellis-api-cleanup.md
- research/07-09-upstream-trellis-opencode-context-exec-hardening.md
- research/07-16-upstream-trellis-hook-shell-semantics.md
- research/07-27-upstream-claude-statusline-utf8-stdin-fix.md
- research/07-27-upstream-trellis-subagent-context-read-hardening.md
- research/07-30-upstream-task-start-branch-recording.md
- research/08-04-trellis-upstream-archive-commit-lock-retry.md
- research/2026-08-08-trellis-0-6-14-upgrade-evidence.md
- research/2026-08-17-trellis-developer-identity-worktree-and-reporting.md
