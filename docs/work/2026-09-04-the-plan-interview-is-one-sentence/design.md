...
(`source:bin/sd-docs-lint::CITATION_RE`) does not care that the match sits inside the
...
backticked syntax that `CITATION_RE` (`source:bin/sd-docs-lint::CITATION_RE`) matches — the
