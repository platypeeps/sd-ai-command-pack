...
exactly that (`prd.md:1371-1376`) — it is the case that otherwise gets
...
`prd.md:1376-1377`'s "wins over detection downward and never upward" — so a repository that gains a collaborator stops
