...
27 (the help text and the rewrite), 13 (the refusal test) and 31 (a, b and
...
implemented now. After #932 merges, in series:
...
list is 5, 16, 18, 21, 22, 27 (the help text and the rewrite), 13 (the
