...
`templates/scripts/sd-ai-command-pack-audit-route.py`, its template twin, the
...
Use this contract when changing
`templates/scripts/sd-ai-command-pack-pr-eligibility.py`, its template twin,
...
- JSON mode: `python3 templates/scripts/sd-ai-command-pack-pr-eligibility.py --input PATH`
...
Use this contract when changing
`templates/scripts/sd-ai-command-pack-housekeeping-result.py`, its template twin,
housekeeping JSON output, coded housekeeping actions/anomalies, or final status
delegation.

### 2. Signatures

- `bash templates/scripts/sd-ai-command-pack-housekeeping.sh --json` reserves stdout for
...
Use this contract when changing
`templates/scripts/sd-ai-command-pack-review-preflight.mjs`, its template twin, or tests
...
Use this contract when changing `templates/scripts/sd-ai-command-pack-record-session.py`,
...
- Validator: `node templates/scripts/sd-ai-command-pack-review-preflight.mjs
...
- `python3 templates/scripts/sd-ai-command-pack-check.py [--json] [--repo PATH]`
- `.sd-ai-command-pack/check.json` [absent: target-repo install path] with exact `schemaVersion: 1`,
...
- Executable: `templates/scripts/sd-ai-command-pack-review-local.py`.
...
- `python3 templates/scripts/sd-ai-command-pack-surface-check.py [--json] [--base-ref REF]`
...
- `bash templates/scripts/sd-ai-command-pack-toolchain.sh doctor [--json]`
- `bash templates/scripts/sd-ai-command-pack-toolchain.sh python [--require-module NAME]...`
- `bash templates/scripts/sd-ai-command-pack-toolchain.sh run-python [--require-module NAME]... -- ARGS...`
...
- Wrapped invocation: `npm exec --no -- c8 --clean=false --reporter=none --temp-directory="$c8_temp_dir" --include="templates/scripts/sd-ai-command-pack-review-preflight.mjs" node templates/scripts/sd-ai-command-pack-review-preflight.mjs ...`
- Report: `npm exec --no -- c8 report --temp-directory="$c8_temp_dir" --include="templates/scripts/sd-ai-command-pack-review-preflight.mjs" --reporter=text --reporter=json-summary --reports-dir="$report_dir"`
