...
| 2 | `templates/scripts/sd-ai-command-pack-review-preflight.mjs` | `c8` | "Report review preflight JavaScript coverage" |
...
- Good: `bash templates/scripts/sd-ai-command-pack-full-check.sh` → shim runs
