...
`.trellis/.version` [absent: target-repo Trellis path]. A checkout below the floor is a violation to be upgraded,
...
`templates/scripts/sd-ai-command-pack-status.py` (template-first source under
