...
- `templates/scripts/sd-ai-command-pack-review-preflight.mjs` (+ `templates/scripts/` mirror)
- `templates/scripts/sd-ai-command-pack-pr-eligibility.py`
- `templates/scripts/sd-ai-command-pack-review.py` (+ `templates/scripts/` mirror), for
...
node --check templates/scripts/sd-ai-command-pack-review-preflight.mjs
diff templates/scripts/sd-ai-command-pack-review-preflight.mjs templates/scripts/sd-ai-command-pack-review-preflight.mjs
```
